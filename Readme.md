...
|---|------------------------------------------------------------------|
| Tela inicial com lista de tarefas | ![Lista](evidencias/01-Tela inicial sem tarefas cadastradas.png) |
| Cadastro de nova tarefa | ![Cadastro](evidencias/02-Cadastro de tarefa.png)                |
| Tarefa cadastrada aparecendo na lista | ![Tarefa criada](evidencias/03-Tela inicial.png)                 |
| Edição de tarefa existente | ![Edição](evidencias/04-Editando tarefa existente.png)           |
| Tarefa marcada como concluída | ![Concluída](evidencias/05-Tarefa marcada como concluída.png)    |
| Exclusão de tarefa | ![Exclusão](evidencias/06-Exclusão de tarefa.png)                |
| Navegação entre lista e formulário | ![Navegação](evidencias/07-navegacao.png)                        |
| Build/execução sem erros | ![Build](evidencias/08-Build-execução sem erros.png)             |
